...
### 📄 Updated
- **CV Artifacts Synchronized from `ricc-cv`**:
  - Updated HSLU university lecturing section to explicitly highlight both continuing education programs: [CAS Cloud Architecture](https://www.hslu.ch/de-ch/informatik/weiterbildung/technologies-and-methods/cas-cloud-architecture/) and [CAS Cloud and Platform Manager (CAS CPM)](https://www.hslu.ch/de-ch/informatik/weiterbildung/technologies-and-methods/cas-cloud/) across 7 consecutive cohorts (CAS CPM 7–13).
  - Synchronized updated `ricc-cv.pdf`, `ricc-cv-it.pdf`, `ricc-onepager.pdf`, `ricc-onepager-it.pdf`, `ricc-onepager.html`, `ricc-onepager-it.html`, `ricc-long-cv.md`, and `index.html`.
...
- 📄 **Curriculum Vitae (EN PDF & HTML)**:
  - Linked `antigravity-ruby-sdk` (`https://github.com/palladius/antigravity-ruby-sdk`) and `sre-extension` (`https://github.com/gemini-cli-extensions/sre`) directly to their GitHub repositories.
