...
Hinweis: Nach diesem Blog-Eintrag habe ich tatsächlich eine Ruby on Rails-Anwendung namens Puffin Tours erstellt, damit meine Frau Inhalte hinzufügen und diese bewerten kann:
...
Puffin Tours organisiert seit 2021 Events für die gesamte Carlesso-Familie, als der Begriff geprägt wurde.
...
{{< img
    ...
    title="Puffin Tours"
    caption="Firmenlogo seit 2021..." alt="image alt" width="40%" position="left" style='vertical-align:middle;' >}}
...
{{< img src="/gallery/midjourney/PalladiusFigata_a_puffin_walking_in_an_ancient_Japanese_town_mi_90659013-0b4d-4a52-a5fb-fe46999f2ba8.png" title="a_puffin_walking_in_an_ancient_Japanese_town_mi" caption="Bild mit Titel, Bildunterschrift, Alt-Text, ..." alt="image alt" width="40%" position="center" >}}
...
{{< img src="/gallery/midjourney/PalladiusFigata_a_happy_puffin_in_Strasbourg_gothic_dark_be4b9df3-f257-4245-bbf1-1173ab259c35.png" title="a_puffin_walking_in_an_ancient_Japanese_town_mi" caption="Bild mit Titel, Bildunterschrift, Alt-Text, ..." alt="image alt" width="40%" position="center" >}}
